Public Class AETVHockeyScoreBoardOut
    ...
    Private Sub LblHemmaLag_Click(sender As Object, e As EventArgs) Handles LblHemmaLag.Click

    End Sub

    Private Sub LblBortaLag_Click(sender As Object, e As EventArgs) Handles LblBortaLag.Click
